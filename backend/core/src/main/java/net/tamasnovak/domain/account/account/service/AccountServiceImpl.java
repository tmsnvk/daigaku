...
import net.tamasnovak.domain.account.account.persistence.AccountRepository;
...
public class AccountServiceImpl implements AccountService {
  ...
  @Override
  @Transactional(readOnly = true)
  public LoginResponse getLoginReturnDto(final LoginRequest body, final Authentication authentication) {
    final Account account = getByEmail(body.email().toLowerCase());
