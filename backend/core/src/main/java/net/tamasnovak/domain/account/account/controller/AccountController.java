package net.tamasnovak.domain.account.account.controller;
...
public class AccountController {
  ...
  @PostMapping(
    ...
    produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<LoginResponse> login(@Valid @RequestBody final LoginRequest body) {
    final Authentication authentication = authenticationFacade.authenticateUser(body.email(), body.password());
    final LoginResponse response = accountService.getLoginReturnDto(body, authentication);
