...
public class StudentApplicationController {
  ...
  public ResponseEntity<ApplicationData> patchByUuid(@PathVariable("uuid") @ValidUUID final UUID uuid,
  ...
  public ResponseEntity<HttpStatus> toggleIsRemovable(@PathVariable("uuid") @ValidUUID final UUID uuid) {
