...
public class PendingAccountController {
   ...
   * The {@link Valid} annotation validates the {@link PendingAccountRegistrationPayload} object as per its validation criteria.
   *
  ...
  public ResponseEntity<HttpStatus> register(@Valid @RequestBody final PendingAccountRegistrationPayload requestBody) {
