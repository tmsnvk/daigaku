...
class PendingAccountRegistrationPayloadTest {
  ...
  Set<ConstraintViolation<PendingAccountRegistrationPayload>> violations = new HashSet<>();
  PendingAccountRegistrationPayload underTest = null;
  ...
  class WhenDtoIsValid {
    ...
    void shouldAssert_thatViolationsSetIsEmpty_whenRequestBodyIsValid() {
      underTest = new PendingAccountRegistrationPayload("Valid", "User", expectedValidEmail, validUuidString, validUuidString);
  ...
  class WhenDtoIsInvalid {
    ...
    void shouldAssert_thatViolationsSetIsNotEmpty_whenFirstNameFailsNotBlankValidation() {
      underTest = new PendingAccountRegistrationPayload("", "User", expectedValidEmail, validUuidString, validUuidString);
    ...
    void shouldAssert_thatViolationsSetIsNotEmpty_whenFirstNameFailsPatternValidation() {
      underTest = new PendingAccountRegistrationPayload("Inv4l-d", "User", expectedValidEmail, validUuidString, validUuidString);
    ...
    void shouldAssert_thatViolationsSetIsNotEmpty_whenLastNameFailsNotBlankValidation() {
      underTest = new PendingAccountRegistrationPayload("Valid", "", expectedValidEmail, validUuidString, validUuidString);
    ...
    void shouldAssert_thatViolationsSetIsNotEmpty_whenLastNameFailsPatternValidation() {
      underTest = new PendingAccountRegistrationPayload("Valid", "!s3r", expectedValidEmail, validUuidString, validUuidString);
    ...
    void shouldAssert_thatViolationsSetIsNotEmpty_whenEmailFailsEmailValidation() {
      underTest = new PendingAccountRegistrationPayload("Valid", "User", "invalidemail.com", validUuidString, validUuidString);
    ...
    void shouldAssert_thatViolationsSetIsNotEmpty_whenInstitutionUuidFailsNotBlankValidation() {
      underTest = new PendingAccountRegistrationPayload("Valid", "User", expectedValidEmail, "", validUuidString);
    ...
    void shouldAssert_thatViolationsSetIsNotEmpty_whenInstitutionUuidFailsUuidConstraintValidation() {
      underTest = new PendingAccountRegistrationPayload("Valid", "User", expectedValidEmail, "invalidUuid", validUuidString);
    ...
    void shouldAssert_thatViolationsSetIsNotEmpty_whenAccountTypeFailsPatternValidation() {
      underTest = new PendingAccountRegistrationPayload("Valid", "User", expectedValidEmail, validUuidString, "invalidUuid");
    ...
    void shouldAssert_thatViolationSetIsNotEmpty_whenRequestBodyFailsMultipleValidations() {
      underTest = new PendingAccountRegistrationPayload("Valid", "!s3r", "invalidemail.com", validUuidString, "invalidUuid");
  ...
  private Set<ConstraintViolation<PendingAccountRegistrationPayload>> validate(PendingAccountRegistrationPayload underTest) {
