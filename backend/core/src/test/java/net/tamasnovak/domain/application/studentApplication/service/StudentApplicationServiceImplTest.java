...
import net.tamasnovak.domain.accountRole.mentor.entity.Mentor;
...
class StudentApplicationServiceImplTest {
  ...
  private final net.tamasnovak.domain.application.shared.entity.Application mockApplication = mock(net.tamasnovak.domain.application.shared.entity.Application.class);
