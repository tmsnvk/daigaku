...
class ApplicationServiceImplTest {
  ...
  class GetByUuidUnitTests {
    ...
    void shouldReturnApplication() {
      net.tamasnovak.domains.application.shared.entity.Application expected = mock(net.tamasnovak.domains.application.shared.entity.Application.class);
      when(applicationRepository.findByUuid(applicationUuid)).thenReturn(Optional.of(expected));

      net.tamasnovak.domains.application.shared.entity.Application actual = underTest.getByUuid(applicationUuid.toString());
