package net.tamasnovak.domains.applicationStages.finalDestinationStatus.controller;
...
public class FinalDestinationStatusController {
  ...
  public ResponseEntity<List<StageSelectOptionDto>> getAllSelectOptions() {
    List<StageSelectOptionDto> response = finalDestinationStatusService.getAllSelectOptions();
