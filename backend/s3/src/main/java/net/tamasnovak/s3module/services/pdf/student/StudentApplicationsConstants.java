...
public class StudentApplicationsConstants {
  final String STUDENT_REQUEST_MAIN_TEMPLATE = """
    <html>
      <head>
        <style>
          * {
  ...
  final String STUDENT_REQUEST_STUDENT_DATA = """
  ...
  final String STUDENT_REQUEST_APPLICATIONS_DATA = """
  ...
  private StudentApplicationsConstants() {}
}
