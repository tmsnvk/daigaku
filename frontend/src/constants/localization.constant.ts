...
export const translations: { name: string; code: TranslationLocale; value: TranslationValue }[] = [
  {
    ...
    value: {
      ...
      // components - form validation
      firstNameRequired: 'Provide your first name(s). Use only letters, hyphens and spaces.',
      lastNameRequired: 'Provide your last name(s). Use only letters, hyphens and spaces.',
