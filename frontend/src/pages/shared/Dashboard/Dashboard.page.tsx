  ...
  return (
    data &&
      <Main>
        ...
        {/*{account.accountRole === AccountRoleE.SYSTEM_ADMIN && <PLACEHOLDER applicationData={applicationData} />}*/}
        {/*{account.accountRole === AccountRoleE.INSTITUTION_ADMIN && <PLACEHOLDER applicationData={applicationData} />}*/}
      </Main>
  );
};
